...
class PatternLockView @JvmOverloads constructor(
    ...
    @ColorInt
    private var attrLineColor = Color.WHITE
    ...
    @ColorInt
    private var attrSuccessDotColor = Color.WHITE

    @ColorInt
    private var attrSuccessLineColor = Color.WHITE
    ...
    init {
        context.theme.obtainStyledAttributes(
            ...
            try {
                ...
                attrDotColor =
                    getColor(R.styleable.PatternLockView_patternLock_dotColor, Color.BLACK)
                attrLineColor =
                    getColor(R.styleable.PatternLockView_patternLock_lineColor, Color.WHITE)
                attrSuccessDotColor =
                    getColor(R.styleable.PatternLockView_patternLock_successDotColor, Color.WHITE)
                attrSuccessLineColor =
                    getColor(R.styleable.PatternLockView_patternLock_successLineColor, Color.WHITE)
                attrErrorDotColor =
                    getColor(R.styleable.PatternLockView_patternLock_errorDotColor, Color.BLACK)
                attrErrorLineColor =
