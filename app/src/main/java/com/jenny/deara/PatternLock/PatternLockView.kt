...
class PatternLockView : GridLayout {
    ...
    constructor(context: Context, attributeSet: AttributeSet) : super(context, attributeSet) {
        var ta = context.obtainStyledAttributes(attributeSet, com.itsxtt.patternlock.R.styleable.PatternLockView)
        regularCellBackground = ta.getDrawable(com.itsxtt.patternlock.R.styleable.PatternLockView_plv_regularCellBackground)
        regularDotColor = ta.getColor(com.itsxtt.patternlock.R.styleable.PatternLockView_plv_regularDotColor, ContextCompat.getColor(context, com.itsxtt.patternlock.R.color.regularColor))
        regularDotRadiusRatio = ta.getFloat(com.itsxtt.patternlock.R.styleable.PatternLockView_plv_regularDotRadiusRatio, DEFAULT_RADIUS_RATIO)

        selectedCellBackground = ta.getDrawable(com.itsxtt.patternlock.R.styleable.PatternLockView_plv_selectedCellBackground)
        selectedDotColor = ta.getColor(com.itsxtt.patternlock.R.styleable.PatternLockView_plv_selectedDotColor, ContextCompat.getColor(context, com.itsxtt.patternlock.R.color.selectedColor))
        selectedDotRadiusRatio = ta.getFloat(com.itsxtt.patternlock.R.styleable.PatternLockView_plv_selectedDotRadiusRatio, DEFAULT_RADIUS_RATIO)

        errorCellBackground = ta.getDrawable(com.itsxtt.patternlock.R.styleable.PatternLockView_plv_errorCellBackground)
        errorDotColor = ta.getColor(com.itsxtt.patternlock.R.styleable.PatternLockView_plv_errorDotColor, ContextCompat.getColor(context, com.itsxtt.patternlock.R.color.errorColor))
        errorDotRadiusRatio = ta.getFloat(com.itsxtt.patternlock.R.styleable.PatternLockView_plv_errorDotRadiusRatio, DEFAULT_RADIUS_RATIO)

        lineStyle = ta.getInt(com.itsxtt.patternlock.R.styleable.PatternLockView_plv_lineStyle, 1)
        lineWidth = ta.getDimensionPixelSize(com.itsxtt.patternlock.R.styleable.PatternLockView_plv_lineWidth,
            TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, DEFAULT_LINE_WIDTH, context.resources.displayMetrics).toInt())
        regularLineColor = ta.getColor(com.itsxtt.patternlock.R.styleable.PatternLockView_plv_regularLineColor, ContextCompat.getColor(context, com.itsxtt.patternlock.R.color.selectedColor))
        errorLineColor = ta.getColor(com.itsxtt.patternlock.R.styleable.PatternLockView_plv_errorLineColor, ContextCompat.getColor(context, com.itsxtt.patternlock.R.color.errorColor))

        spacing = ta.getDimensionPixelSize(com.itsxtt.patternlock.R.styleable.PatternLockView_plv_spacing,
            TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, DEFAULT_SPACING, context.resources.displayMetrics).toInt())

        plvRowCount = ta.getInteger(com.itsxtt.patternlock.R.styleable.PatternLockView_plv_rowCount, DEFAULT_ROW_COUNT)
        plvColumnCount = ta.getInteger(com.itsxtt.patternlock.R.styleable.PatternLockView_plv_columnCount, DEFAULT_COLUMN_COUNT)

        errorDuration = ta.getInteger(com.itsxtt.patternlock.R.styleable.PatternLockView_plv_errorDuration, DEFAULT_ERROR_DURATION)
        hitAreaPaddingRatio = ta.getFloat(com.itsxtt.patternlock.R.styleable.PatternLockView_plv_hitAreaPaddingRatio, DEFAULT_HIT_AREA_PADDING_RATIO)
        indicatorSizeRatio = ta.getFloat(com.itsxtt.patternlock.R.styleable.PatternLockView_plv_indicatorSizeRatio, DEFAULT_INDICATOR_SIZE_RATIO)
